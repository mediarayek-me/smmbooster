                    ...
                    <div class="block block-transparent block-rounded w-100 mb-0 overflow-hidden">
                        ...
                        <div class="block-content block-content-full px-lg-5 px-xl-6 py-4 py-md-5 py-lg-6 bg-white">
                            ...
                            <div class="mb-2 text-center">
                                ...
                                <p class="text-uppercase font-w700 font-size-sm text-muted">{{Helper::getLang('Reset Password')}}</p>
                            </div>
                            <!-- END Header -->
                            @if (request()->is('admin/*'))
                            <form class="js-validation-reminder" action="{{route('admin.password.update')}}" method="post">
                            @else
                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input id="password" type="password" class="form-control  @error('password') is-invalid @enderror" name="password"  placeholder="{{Helper::getLang('Password')}}" value="{{ old('password') }}" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input id="password-confirm" type="password" class="form-control  @error('password_confirmation') is-invalid @enderror" name="password_confirmation"  placeholder="{{Helper::getLang('Confirm Password')}}" value="{{ old('password_confirmation') }}" required>
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="fa fa-asterisk"></i>
                                            </span>
